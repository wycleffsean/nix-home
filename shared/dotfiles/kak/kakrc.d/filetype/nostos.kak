...
hook -group lsp-filetype-nostos global BufSetOption filetype=nostos %{
    set-option buffer lsp_servers %{
        [nostos]
        filetypes = ["nostos"]
        root_globs = [".git", ".hg"]
        command = "/home/sean/code/sr.ht/scarey/nostos/bin/nostos"
        args = ["lsp"]
        # args = ["nostos"]
        # command = "sh"
        # command = "gopls"
        # args = ["-c", "cd /home/my_dude/code/sr.ht/scarey/nostos && bin/nostos lsp"]
    }
}
